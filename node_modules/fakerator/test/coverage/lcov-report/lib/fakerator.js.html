  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>117/134</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
	self.random = {
		number(max = <span class="branch-0 cbranch-no" title="branch not covered" >9999, min = 0, precision = 1) {</span>
			if (min &gt; max) {
				// Swap values
				[min, max] = [max, min];
			}
...
&nbsp;
	self.slugify = function (str = <span class="branch-0 cbranch-no" title="branch not covered" >"") {</span>
		return str.trim().replace(/ /g, "-").replace(/[^\w\.\-]+/g, "");
	};
&nbsp;
	self.replaceSymbols = function (format, numberSymbol = <span class="branch-1 cbranch-no" title="branch not covered" >"</span>#", alphaSymbol = <span class="branch-1 cbranch-no" title="branch not covered" >"</span>\\?") {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jul 01 2016 18:49:30 GMT+0200 (Central Europe Daylight Time)
</div>
</div>
